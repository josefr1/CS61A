...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    sum1 = (get_lat(city_a) - get_lat(city_b))**2
    sum2 = (get_lon(city_a) - get_lon(city_b))**2
...
def closer_city(lat, lon, city_a, city_b):
    ...
    elif distance(coordinate, city_a) > distance(coordinate, city_b):
        return get_name(city_b)
    else:
...
def sprout_leaves(t, leaves):
    ...
    sprouted_branches = [sprout_leaves(a, leaves) for a in branches(t)]
